...
class Game {
    ...
    draw() {
        ...
        if (this.labMode === 'hud' && assets.notification) {
            ...
            ctx.drawImage(assets.notification, sx, sy, fw, fh, n.x - dw/2, n.y - dh/2, dw, dh);
        ...
        if (cur) {
            ...
            if(this.labMode === 'hud') ctx.fillText(`TEXT OFFSET: ${cur.textX}, ${cur.textY} | V: CYCLE FRAME`, 20, 160);
        }
        ctx.restore();
    }
}
